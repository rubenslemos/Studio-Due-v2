...
export function updateAgendamento(key, value) {return {type: types.UPDATE_AGENDAMENTO, key, value}}
export function updateForm(key, value) {return {type: types.UPDATE_FORM, key, value}}
